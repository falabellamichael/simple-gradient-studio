...
- Added the standalone SimpleGradient Studio VS Code extension.
- Added global, page, and panel gradient inheritance.
- Added targetable live preview and assignment matrix.
